...
import elevatorDoorOpeningClearanceImg from "./assets/ElevatorDoorOpeningClearance.JPG";
import elevatorGovernorTesterImg from "./assets/ElevatorGovernorTester.JPG";
...
import escalatorSyncRateImg from "./assets/EscalatorSynchronizationRateTester.jpg";
import escalatorComprehensiveEvalImg from "./assets/EscalatorComprehensivePerformanceSafetyEvaluation.jpg";
import escalatorComprehensiveTesterImg from "./assets/EscalatorComprehensiveTester.jpg";
import escalatorSpeedDisplacementImg from "./assets/EscalatorSpeedDisplacementTester.jpg";
import escalatorEngagementDepthImg from "./assets/EscalatorDynamicEngagementDepthMeasuring.jpg";
import escalatorApronClearanceImg from "./assets/EscalatorDynamicClearanceMeasuringForApron.jpg";
import escalatorMultifunctionalRulerImg from "./assets/EscalatorElevatorMultifunctionalMeasuringRuler.png";
...
const escalatorEquipment = [
  { id: "sync-rate", image: escalatorSyncRateImg, name: "Escalator Synchronization Rate Tester", tagline: "Precision Testing for Step Chain and Handrail Speed Synchronization", desc: "Measures the synchronization between step chain and handrail speeds to ensure passenger safety and comfort. Detects speed deviations that could cause falls or entrapment.", features: ["Dual-channel speed measurement", "Real-time sync ratio display", "Wireless handrail speed sensor", "Data logging with trend analysis", "EN 115 compliant"], color: "#1a5276" },
  { id: "comprehensive-eval", image: escalatorComprehensiveEvalImg, name: "Comprehensive Performance & Safety Evaluation System", tagline: "Integrated Testing Solution for Full Escalator Performance & Safety Compliance", desc: "An all-in-one system that evaluates multiple escalator performance parameters simultaneously — speed, vibration, noise, step alignment, and emergency response.", features: ["Multi-parameter simultaneous testing", "Integrated sensor suite", "Automated compliance reporting", "Cloud data upload capability", "Full EN 115 test coverage"], color: "#1e8449" },
  { id: "comprehensive-tester", image: escalatorComprehensiveTesterImg, name: "Comprehensive Tester for Escalator", tagline: "All-in-One Instrument for Escalator Performance & Safety Testing", desc: "Portable multi-function tester combining speed measurement, vibration analysis, and operational parameter monitoring into a single instrument for field use.", features: ["Speed, vibration & noise in one unit", "Touchscreen interface", "Built-in compliance calculations", "Rechargeable long-life battery", "Rugged field-ready enclosure"], color: "#7d3c98" },
  { id: "speed-displacement", image: escalatorSpeedDisplacementImg, name: "Escalator Speed Displacement Tester", tagline: "Precision Measurement of Escalator Speed and Step Movement Accuracy", desc: "Measures escalator step speed and displacement accuracy to detect irregularities in step chain movement that could affect passenger safety.", features: ["High-resolution optical encoder", "Step-by-step displacement tracking", "Speed deviation alerting", "Compact mounting system", "Real-time graph display"], color: "#c0392b" },
  { id: "engagement-depth", image: escalatorEngagementDepthImg, name: "Dynamic Engagement Depth Measuring Instrument", tagline: "Precision Measurement for Step and Comb Plate Engagement Safety", desc: "Measures the dynamic engagement depth between escalator steps and comb plates during operation to prevent entrapment and ensure safe step-to-comb transition.", features: ["Dynamic measurement during operation", "High-precision laser sensors", "Continuous monitoring mode", "Threshold alarm system", "Compact probe design"], color: "#2e86c1" },
  { id: "apron-clearance", image: escalatorApronClearanceImg, name: "Dynamic Clearance Measuring Instrument for Apron Board", tagline: "Real-Time Measurement of Step-to-Apron Board Clearance for Safety Compliance", desc: "Measures the clearance between moving steps and stationary apron boards in real-time to ensure gaps remain within safety limits and prevent foot entrapment.", features: ["Real-time gap monitoring", "Non-contact measurement technology", "Sub-millimetre precision", "Continuous logging capability", "Visual & audible alerts on deviation"], color: "#d4ac0d" },
  { id: "multifunctional-ruler", image: escalatorMultifunctionalRulerImg, name: "Escalator/Elevator Multifunctional Measuring Ruler", tagline: "4th Generation Multi-Purpose Detection Ruler for Elevators & Escalators", desc: "The fourth generation multi-purpose detection ruler designed for measuring elevator and escalator clearances, engagement distances, apron plate gaps, comb plate engagement depth, handrail inner edge clearance, and steel wire rope diameter. Convenient to install, fast to operate and accurate to detect.", features: ["Measuring range 0–32mm, resolution 0.01mm", "Two-segment mechanical clamping design with zero-setting at any position", "Detects engagement depth directly without calibration", "Data output via serial interface to computer or printer", "Covers most elevator and escalator detection applications"], color: "#117a65" },
];
...
<div class="item">
  ...
  <div class="footer">© 2026 Singapore Lift Inspection Testing Pte Ltd | enquiry@sgliftest.com | +65 9615 1522</div>
</div>`).join('')}
</body></html>`;
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 40 }}>
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, color: "rgba(255,255,255,0.6)", fontSize: 13 }}><Icons.Mail /> enquiry@sgliftest.com</div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              <div style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: 14, color: styles.colors.gray500 }}>enquiry@sgliftest.com</p>
                </div>
              </div>
              <div style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
